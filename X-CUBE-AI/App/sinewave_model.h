/**
  ...
  ******************************************************************************
  */
#ifndef AI_SINEWAVE_MODEL_H
#define AI_SINEWAVE_MODEL_H

#include "sinewave_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINEWAVE_MODEL_MODEL_NAME          "sinewave_model"
#define AI_SINEWAVE_MODEL_ORIGIN_MODEL_NAME   "sinewave_model"

/******************************************************************************/
#define AI_SINEWAVE_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINEWAVE_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINEWAVE_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SINEWAVE_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_SINEWAVE_MODEL_IN \
  ai_sinewave_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINEWAVE_MODEL_IN_SIZE { \
  AI_SINEWAVE_MODEL_IN_1_SIZE, \
}
#define AI_SINEWAVE_MODEL_IN_SIZE_BYTES { \
  AI_SINEWAVE_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_SINEWAVE_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINEWAVE_MODEL_IN_1_CHANNEL     (1)
#define AI_SINEWAVE_MODEL_IN_1_SIZE        (1)
#define AI_SINEWAVE_MODEL_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINEWAVE_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SINEWAVE_MODEL_OUT \
  ai_sinewave_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINEWAVE_MODEL_OUT_SIZE { \
  AI_SINEWAVE_MODEL_OUT_1_SIZE, \
}
#define AI_SINEWAVE_MODEL_OUT_SIZE_BYTES { \
  AI_SINEWAVE_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_SINEWAVE_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINEWAVE_MODEL_OUT_1_CHANNEL     (1)
#define AI_SINEWAVE_MODEL_OUT_1_SIZE        (1)
#define AI_SINEWAVE_MODEL_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINEWAVE_MODEL_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup sinewave_model
 ...
 * @ref ai_sinewave_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_sinewave_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sinewave_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sinewave_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SINEWAVE_MODEL_*
 * defines into file @ref sinewave_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sinewave_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINEWAVE_MODEL_H */
